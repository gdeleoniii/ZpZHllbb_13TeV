...
void plot(string channel, string flavor){

  readHist zjets100(Form("Zjets/DYJetsToLL_M-50_HT-100to200_13TeV_%sMCbtagEff.root", channel.data()));
  readHist zjets200(Form("Zjets/DYJetsToLL_M-50_HT-200to400_13TeV_%sMCbtagEff.root", channel.data()));
  readHist zjets400(Form("Zjets/DYJetsToLL_M-50_HT-400to600_13TeV_%sMCbtagEff.root", channel.data()));
  readHist zjets600(Form("Zjets/DYJetsToLL_M-50_HT-600toInf_13TeV_%sMCbtagEff.root", channel.data()));
  ...
  TH1F h("h", "", (flavor=="udsg")?nvarBinslight:nvarBins, (flavor=="udsg")?varBinslight:varBins);
