  ...
  \begin{tiny}
    \begin{center}
      \begin{tabular}{ | l | l | }
        ...
        \hline
      \end{tabular}
      \captionof{table}{\footnotesize{MC samples used and corresponding cross section values (K-factors for DY samples are included for normalization). The MC samples are miniAOD V1. MC weights are applied for amcAtNLO samples.}}
    \end{center}
  \end{tiny}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{ll}
      \includegraphics[width=0.5\textwidth]{withCSV.jpg} &
      \includegraphics[width=0.5\textwidth]{withoutCSV.jpg} \\
    \end{tabular}
    \captionof{table}{\footnotesize{The pruned mass distribution with (left) and without (right) subjet CSV cut. It show that the event is reduced so much if subjet CSV cut is apply. Both distributions are normalize to L = 837.1 $pb^{-1}$.}}
  \end{center}
\end{frame}
\begin{frame}
  \frametitle{Corrected pruned mass}
  \begin{center}
    \includegraphics[page=1,width=0.8\textwidth]{alphaRatio.pdf}
  \end{center}
\end{frame}
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{ll}
      \includegraphics[page=2,width=0.5\textwidth]{alphaRatio.pdf} &
      \includegraphics[page=3,width=0.5\textwidth]{alphaRatio.pdf} \\
    \end{tabular}
    \captionof{table}{\footnotesize{Number of backgrounds in signal region: 172.231 + 17.792 - 22.8458}}
  \end{center}
\end{frame}
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{ll}
      ...
      \includegraphics[page=5,width=0.5\textwidth]{alphaRatio.pdf} \\
    \end{tabular}
  \end{center}
\end{frame}
\begin{frame}
  ...
  \begin{center}
    \includegraphics[page=6,width=0.8\textwidth]{alphaRatio.pdf}
  \end{center}
\end{frame}
\begin{frame}
...
\begin{frame}
  \frametitle{Results}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{XZHllbb_Counting_Asymptotic_log.pdf}
  \end{center}
\end{frame}
\begin{frame}
