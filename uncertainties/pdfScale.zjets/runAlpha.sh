...
#	root -q -b -l rooFitAlpha.C\(\"${channel[$i]}\"\,\"${cat[$j]}\"\,\"mur1\"\,0\,2\)
#	root -q -b -l rooFitAlpha.C\(\"${channel[$i]}\"\,\"${cat[$j]}\"\,\"pdf\"\,9\,109\)
	root -q -b -l rooFitDataZZZ.C\(\"${channel[$i]}\"\,\"${cat[$j]}\"\,\"mur1\"\,0\,2\)
    done
done
