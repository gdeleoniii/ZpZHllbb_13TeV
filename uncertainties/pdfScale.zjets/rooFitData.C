...
void rooFitData(string channel, string catcut){
  ...
  RooRealVar evWeight("evweight[1]", "", -1.e10, 1.e10);
  ...
  model_alpha.plotOn(alphaFrame, LineColor(kBlue));
  /*
  ...
  */  
  ...
  c->Print(Form("alpha_pdfScale_%s_cat%s.pdf", channel.data(), catcut.data()));
