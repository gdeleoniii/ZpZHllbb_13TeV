...
void muHighPtVariable(std::string inputFile, std::string outputFile){
  ...
  for( Long64_t ev = data.GetEntriesFast()-1; ev >= 0; --ev ){
	...
	for(Int_t flag = 0; flag <= 7; flag++){
	  ...
	  case 0: h_muHits      ->Fill(muHits[muId[ie]],eventWeight);      break;
	  case 1: h_muMatches   ->Fill(muMatches[muId[ie]],eventWeight);   break;
	  case 2: h_muTrkLayers ->Fill(muTrkLayers[muId[ie]],eventWeight); break;
	  case 3: h_muPixelHits ->Fill(muPixelHits[muId[ie]],eventWeight); break;
	  case 4: h_muTrkPtErrdvTrkPt ->Fill(muTrkPtErr[muId[ie]]/muTrkPt[muId[ie]],eventWeight); break;
	  case 5: h_mudxy       ->Fill(mudxy[muId[ie]],eventWeight);       break; 
	  case 6: h_mudz        ->Fill(mudz[muId[ie]],eventWeight);        break;
	  case 7: h_muMiniIsoEA ->Fill(muMiniIsoEA[muId[ie]],eventWeight); break;
